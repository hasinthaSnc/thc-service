...
const STRINGS = {
  EMAIL_MSG_NO_SKU_AVAILABLE:
    "The fulfillment of this order within Amazon Seller Central has encountered an issue due to the absence of corresponding Shopify product SKUs in the Amazon Seller Central inventory. This disparity in SKUs between the two platforms has led to the current fulfillment shortfall",
  EMAIL_MSG_SERVER_ERROR:
    "the fulfillment of this order through Amazon Seller Central is currently impeded due to a server error. This has resulted in the unavailability of Shopify product SKUs within the Amazon Seller Central system, contributing to the existing fulfillment challenge.",
};
